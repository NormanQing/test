...
$module_ini = array(
	...
	"module_date" 		=> "2012-01-27 16:51:40",
	"en"	=>	array(
		"Application"	=>	array(
				"Name"		=>	"PhpMyAdmin",
				"Version"	=>	"3.4.9",
...
echo "<div class='modules'>";
	...
	if ($_GET['to'] == $file) { 
		echo "<div class='module_parameters_frame'>";
			...
			echo "<div class='module_ini_settings'>" . $module_uninstall_db . "</div>";
			echo "<div class='module_ini_settings' style='text-align:center;color:#BFB800;'><pre>" . $file . "</pre></div>";
		echo "</div>";
	}
	/* ---------- */
